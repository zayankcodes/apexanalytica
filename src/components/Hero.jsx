  ...
  return (
    <section className="relative z-10 mt-24">
      <div className="container mx-auto px-4">
        <motion.div
          className="group mx-auto max-w-6xl grid grid-cols-1 overflow-hidden rounded-md bg-primary-light/60 backdrop-blur-sm md:grid-cols-2"
        ...
        >
          {/* COPY SIDE */}
          <motion.div className="p-12 md:p-16" variants={container}>
